...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div id="report" className="min-h-screen bg-gray-100">
            <Toaster />
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink
                                    ...
                                    active={route().current("tender.index")}
                                >
                                    Tender
                                </NavLink>
                            </div>
                            ...
                            {user.isAdmin == 1 && (
                                <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                    <NavLink href={route("product.admin")} active={route().current("product.admin")}>
                                        Admin
                                    </NavLink>
                                </div>
                            )}
                ...
                >
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink href={route("tender.index")}>
                                Tender
                            </ResponsiveNavLink>
                            {user.isAdmin == 1 && (
                                <ResponsiveNavLink
