...
export default function AddTender(props) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        beamanglesecond: "",
        driversecond: "",
        colorconsistencysecond: "",
        lamptypesecond: "",

        // Third Product

        categorythird: "",
        assignproductidthird: "",
        notesthird: "",
        modelthird: "",
        temperaturethird: "",
        ipclassthird: "",
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    !uploadPhotometric ? ( <>
                                                        <img
                                                            ...
                                                            height="250px"
                                                        />
                                                        <input type="hidden" name="photometricphotopath" value={data.photometricphoto.path} />
                                                         </>
                                                    ) : (
                                                        <h1 className="font-bold text-lg text-gray-500 py-3">
                                                            {" "}
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 ">
                                            <div className="mb-3 mr-2">
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    !uploadMainSecond ? ( <>
                                                        <img
                                                            ...
                                                            height="250px"
                                                        />
                                                        <input type="hidden" name="mainphotopathsecond" value={data.mainphotosecond.path} />
                                                         </>
                                                    ) : (
                                                        <h1 className="font-bold text-lg text-gray-500 py-3">
                                                            {" "}
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    <input
                                                        onChange={
                                                            onHandleChangeMainSecond
                                                        }
                                                        type="file"
                                                        name="mainphotosecond"
                                                        id="mainphotosecond"
                                                        className="hidden"
                                                        placeholder="Intel"
                                                    />
                                            ...
                                            <div className="mb-3 mr-2">
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    !uploadDimensionSecond ? ( <>
                                                        <img
                                                            ...
                                                            height="250px"
                                                        />
                                                        <input type="hidden" name="dimensionphotopathsecond" value={data.dimensionphotosecond.path} />
                                                        </>
                                                    ) : (
                                                        <h1 className="font-bold text-lg text-gray-500 py-3">
                                                            {" "}
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    <input
                                                        onChange={
                                                            onHandleChangeDimensionSecond
                                                        }
                                                        type="file"
                                                        name="dimensionphotosecond"
                                                        id="dimensionphotosecond"
                                                        className="hidden"
                                                        placeholder="Intel"
                                                    />
                                                </div>
                                            ...
                                            <div className="mb-3 mr-2">
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    !uploadPhotometricSecond ? ( <>
                                                        <img
                                                            ...
                                                            height="250px"
                                                        />
                                                        <input type="hidden" name="photometricphotopathsecond" value={data.photometricphotosecond.path} />
                                                        </>
                                                    ) : (
                                                        <h1 className="font-bold text-lg text-gray-500 py-3">
                                                            {" "}
                                                ...
                                                <div className="mt-1">
                                                    <label
                                                        htmlFor="photometricphotosecond"
                                                        required
                                                        className={`
                                                        ${
                                                            uploadPhotometricSecond
                                                    ...
                                                    <input
                                                        onChange={
                                                            onHandleChangePhotometricSecond
                                                        }
                                                        type="file"
                                                        name="photometricphotosecond"
                                                        id="photometricphotosecond"
                                                        className="hidden"
                                                        placeholder="Intel"
                                                    />
                                                </div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 ">
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    !uploadMainThird ? ( <>
                                                        <img
                                                            ...
                                                            height="250px"
                                                        />
                                                        <input type="hidden" name="mainphotopaththird" value={data.mainphotothird.path} />
                                                        </>
                                                    ) : (
                                                        <h1 className="font-bold text-lg text-gray-500 py-3">
                                                            {" "}
                                            ...
                                            <div className="mb-3 mr-2">
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    !uploadDimensionThird ? ( <>
                                                        <img
                                                            ...
                                                            width="250px"
                                                            height="250px"
                                                        /> <input type="hidden" name="dimensionphotopaththird" value={data.dimensionphotothird.path} /> </>
                                                    ) : (
                                                        <h1 className="font-bold text-lg text-gray-500 py-3">
                                                            {" "}
                                                            Custom Upload{" "}
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    <input
                                                        onChange={
                                                            onHandleChangeDimensionThird
                                                        }
                                                        type="file"
                                                        name="dimensionphotothird"
                                                        id="dimensionphotothird"
                                                        className="hidden"
                                                        placeholder="Intel"
                                                    />
                                                </div>
                                            ...
                                            <div className="mb-3 mr-2">
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    !uploadPhotometricThird ? ( <>
                                                        <img
                                                            ...
                                                            height="250px"
                                                        />
                                                        <input type="hidden" name="photometricphotopaththird" value={data.photometricphotothird.path} />
                                                          </>
                                                    ) : (
                                                        <h1 className="font-bold text-lg text-gray-500 py-3">
                                                            {" "}
                                                ...
                                                <div className="mt-1">
                                                    ...
                                                    <input
                                                        onChange={
                                                            onHandleChangePhotometricThird
                                                        }
                                                        type="file"
                                                        name="photometricphotothird"
                                                        id="photometricphotothird"
                                                        className="hidden"
                                                        placeholder="Intel"
                                                    />
                                                </div>
